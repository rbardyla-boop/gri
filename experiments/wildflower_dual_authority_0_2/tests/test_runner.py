...
from experiments.wildflower_dual_authority_0_2 import run_dual_authority02 as runner
...
def test_only_seed_320_is_authorized_for_execution() -> None:
    runner._assert_seed_authorized(320)
...
def test_selector_payload_is_exact_and_disjoint() -> None:
    selection = runner._selection(320)
    payload = runner._selector_payload(320, selection)
    assert payload["starts"] == {
        "training": 2_000_000,
        "ordinary_test": 2_050_000,
        "challenge": 2_100_000,
    }
    assert payload["ranges"] == {
        "training": (2_000_000, 2_049_999),
        "ordinary_test": (2_050_000, 2_099_999),
        "challenge": (2_100_000, 2_149_999),
    }
...
def test_selected_episode_seeds_are_generated_from_preregistered_ranges() -> None:
    selection = runner._selection(320)
    roots = {
        "training": (320 + runner.design.TRAIN_SELECTOR_ROOT_OFFSET, 2_000_000),
        "ordinary_test": (
            320 + runner.design.ORDINARY_TEST_SELECTOR_ROOT_OFFSET,
            2_050_000,
        ),
        "challenge": (320 + runner.design.CHALLENGE_SELECTOR_ROOT_OFFSET, 2_100_000),
    }
